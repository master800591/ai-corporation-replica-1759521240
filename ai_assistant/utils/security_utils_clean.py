...
- Simple key generation and digital signatures
...
from .simple_crypto_utils import (
    ...
    hash_message, generate_random_bytes, generate_random_string,
    encode_base64, decode_base64, check_crypto_availability
)
...
class SecurityManager:
    ...
    def create_secure_user(self, username: str, email: str, password: str,
                          generate_keys: bool = True, key_algorithm: str = 'simple',
    ...
    def regenerate_user_keys(self, user_id: str, algorithm: str = 'simple') -> Dict[str, Any]:
    ...
    def get_security_status(self) -> Dict[str, Any]:
        ...
        active_sessions = [s for s in self.user_manager.sessions.values() if s.is_active]
